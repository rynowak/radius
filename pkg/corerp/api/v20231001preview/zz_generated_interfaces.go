...
// Use a type switch to determine the concrete type.  The possible types are:
// - *BicepRecipeProperties, *PromiseRecipeProperties, *RecipeProperties, *TerraformRecipeProperties
...
// Use a type switch to determine the concrete type.  The possible types are:
// - *BicepRecipePropertiesUpdate, *PromiseRecipePropertiesUpdate, *RecipePropertiesUpdate, *TerraformRecipePropertiesUpdate
