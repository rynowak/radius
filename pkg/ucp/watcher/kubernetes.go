...
func (c *crdEventHandler) Create(ctx context.Context, evt event.TypedCreateEvent[runtimeclient.Object], _ workqueue.RateLimitingInterface) {
...
func (c *crdEventHandler) Delete(ctx context.Context, evt event.TypedDeleteEvent[runtimeclient.Object], _ workqueue.RateLimitingInterface) {
	obj := evt.Object.(*apiextv1.CustomResourceDefinition)
...
func (c *crdEventHandler) Generic(context.Context, event.TypedGenericEvent[runtimeclient.Object], workqueue.RateLimitingInterface) {
}

func (c *crdEventHandler) Update(context.Context, event.TypedUpdateEvent[runtimeclient.Object], workqueue.RateLimitingInterface) {
}
