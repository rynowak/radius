...
func Test_Routes(t *testing.T) {
	// We don't define any routes for the Kubernetes module.
	// This test just verifies that we can initialize it.
	tests := []rpctest.HandlerTestSpec{
		{
			OperationType: v1.OperationType{Type: "System.Planes/kubernetes", Method: v1.OperationList},
			Method:        http.MethodGet,
			Path:          "/planes/kubernetes",
		}, {
			OperationType: v1.OperationType{Type: "System.Planes/kubernetes", Method: v1.OperationGet},
			Method:        http.MethodGet,
			Path:          "/planes/kubernetes/someName",
		}, {
			OperationType: v1.OperationType{Type: "System.Planes/kubernetes", Method: v1.OperationPut},
			Method:        http.MethodPut,
			Path:          "/planes/kubernetes/someName",
		}, {
			OperationType: v1.OperationType{Type: "System.Planes/kubernetes", Method: v1.OperationDelete},
