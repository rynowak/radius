...
func Test_ValidateDownstream(t *testing.T) {
	...
	resourceProviderID, err := datamodel.ResourceProviderIDFromResourceID(id)
	require.NoError(t, err)
	...
	locationResource := &datamodel.Location{
		BaseResource: v1.BaseResource{
			TrackedResource: v1.TrackedResource{
				Name: location,
				ID:   resourceProviderID.Append(resources.TypeSegment{Type: "locations", Name: location}).String(),
			},
		},
	...
	t.Run("location error found", func(t *testing.T) {
		resourceGroup := &datamodel.ResourceGroup{
			BaseResource: v1.BaseResource{
				TrackedResource: v1.TrackedResource{
					ID: id.RootScope(),
		...
		expected := fmt.Errorf("failed to find location %q: %w", locationResource.ID, errors.New("test error"))
	...
	t.Run("api-version not found", func(t *testing.T) {
		resourceGroup := &datamodel.ResourceGroup{
			BaseResource: v1.BaseResource{
				TrackedResource: v1.TrackedResource{
					ID: id.RootScope(),
...
func Test_ValidateDownstream_Legacy(t *testing.T) {
	...
	locationResourceID := resourceProviderID.Append(resources.TypeSegment{Type: "locations", Name: location})
	...
	t.Run("success (resource group)", func(t *testing.T) {
		...
		mock.EXPECT().Get(gomock.Any(), id.PlaneScope()).Return(&store.Object{Data: plane}, nil).Times(1)
		mock.EXPECT().Get(gomock.Any(), id.RootScope()).Return(&store.Object{Data: resourceGroup}, nil).Times(1)
		mock.EXPECT().Get(gomock.Any(), locationResourceID.String()).Return(nil, &store.ErrNotFound{}).Times(1)
