...
func (p *ProxyController) UpdateTrackedResource(ctx context.Context, downstreamURL string, originalID resources.ID, version string) error {
	return p.updater.Update(ctx, downstreamURL, originalID, version)
}
