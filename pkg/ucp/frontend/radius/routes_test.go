...
func Test_Routes(t *testing.T) {
	tests := []rpctest.HandlerTestSpec{
		{
			OperationType: v1.OperationType{Type: "System.Planes/radius", Method: v1.OperationList},
			Method:        http.MethodGet,
			Path:          "/planes/radius",
		},
		{
			OperationType: v1.OperationType{Type: "System.Planes/radius", Method: v1.OperationGet},
			Method:        http.MethodGet,
			Path:          "/planes/radius/someName",
		},
		{
			OperationType: v1.OperationType{Type: "System.Planes/radius", Method: v1.OperationPut},
			Method:        http.MethodPut,
			Path:          "/planes/radius/someName",
		},
		{
			OperationType: v1.OperationType{Type: "System.Planes/radius", Method: v1.OperationDelete},
