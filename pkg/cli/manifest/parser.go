...
func createValidator() yaml.StructValidator {
	...
	_ = v.RegisterValidation("namespace", validateNamespace)
	_ = v.RegisterTranslation("namespace", translator, func(ut ut.Translator) error {
		return ut.Add("namespace", namespaceMessage, true)
	}, func(ut ut.Translator, fe validator.FieldError) string {
		t, _ := ut.T("namespace", fe.Field())
		return t
	})
