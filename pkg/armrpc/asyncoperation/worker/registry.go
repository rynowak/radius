...
func (h *ControllerRegistry) Get(ctx context.Context, operationType v1.OperationType) (ctrl.Controller, error) {
	...
	return h.createDefault(ctx, operationType)
}

func (h *ControllerRegistry) createDefault(ctx context.Context, operationType v1.OperationType) (ctrl.Controller, error) {
