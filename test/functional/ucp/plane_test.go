...
func Test_Plane_Operations(t *testing.T) {
	...
	t.Run("AWS", func(t *testing.T) {
		test := NewUCPTest(t, "AWS_Plane_Operations", func(t *testing.T, url string, roundTripper http.RoundTripper) {
			apiVersion := v20231001preview.Version
	...
	t.Run("Azure", func(t *testing.T) {
		test := NewUCPTest(t, "Azure_Plane_Operations", func(t *testing.T, url string, roundTripper http.RoundTripper) {
			apiVersion := v20231001preview.Version
	...
	t.Run("Radius", func(t *testing.T) {
		test := NewUCPTest(t, "Radius_Plane_Operations", func(t *testing.T, url string, roundTripper http.RoundTripper) {
			apiVersion := v20231001preview.Version
